...
You may also like to view the course [Learning Objectives](https://github.com/opetchey/BIO144/blob/master/1_learning_objectives/Weekly_learning_objectives.pdf).
...
We do assume some basic R knowledge. We suggest you prepare by looking through Chapter 2 of the [Insights from data book](https://academic.oup.com/book/39565). A few weeks before the course begins we distribute other instructions to help students prepare for the course.
...
*If you are not happy with any of these points, please do not apply to be a TA for this course.*
...
A doodle where one can sign up for the teaching slots will be sent in December.
