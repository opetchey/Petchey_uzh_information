...
All information below is valid for Spring Semester 2024.

## Taking the course

We are planning for in-person on-site lectures and practicals, but will also record all lectures for later viewing (podcasts). We will be ready to move to online-only format as required.
...
Please see the important information in the [UZH Vorlesungverzeichnis/Course Catalogue](https://studentservices.uzh.ch/uzh/anonym/vvz/index.html).

You may also view the course [Learning Objectives](https://github.com/opetchey/BIO144/blob/master/1_learning_objectives/Weekly_learning_objectives.pdf).
...
We do assume some basic R knowledge. I suggest you prepare by looking through Chapter 2 of the [Insights from data book](https://academic.oup.com/book/39565). A few weeks before the course begins we distribute other instructions to help students prepare for the course.
...
Courses that might interest you after having done BIO144, that follow on in the quantitative / modelling / programming / data science realm are listed on [this spreadsheet](assets/QuantitativeModules.xlsx). Note that it may not be completely up to date, so please consult the [UZH module directory](www.vorlesungen.uzh.ch) to check for currency and also further details.

## TAing BIO144

**For TAing in the coming session: this will be organised from October onwards. Please then contact Martina Jelic (email address on this web page: https://www.ieu.uzh.ch/member/current.php).**         
...
Here are the [regulations regarding an external research internship](assets/extForschungsprakt.pdf). There are a few things to do in order to get approval for an external research internship to contribute credit points.
 ...
 1. Contact Prof Petchey with your idea. You can find his email address on <a href="https://www.ieu.uzh.ch/member/current.php">this</a> page.
...
This course runs in fall semester. [Further information about the course is here](https://mnf.openedx.uzh.ch/courses/course-v1:MNF+multi_module+multi_date/about). For any information about registration please contact Maja Weilenmann. You can find her email address [here](https://www.ieu.uzh.ch/member/current.php).
