...
Please see the important information in the [UZH Vorlesungverzeichnis/Course Catalogue](https://studentservices.uzh.ch/uzh/anonym/vvz/index.html). Please send any enquiries to [the course email address](mailto:bio144@ieu.uzh.ch). You may also view the course [Learning Objectives](https://github.com/opetchey/BIO144/blob/master/1_learning_objectives/Weekly_learning_objectives.pdf).
...
> Dear Students
>
>Welcome to BIO144, Data Analysis in Biology.
>
>All information about the course is provided via the online learning platform edu-exchange (another installation of openedx). I am sorry that this is probably a new platform for you to register on and use. Please go here (https://edu-exchange.uzh.ch/), click on “Sign in” in the top right corner, and follow the instructions.
>
...
>
> By the way, you need to bring a laptop to the first (and every other) class.
>
> Please use the online course discussion forum for any queries, or do so in person during the first class.
>
> Please address any email enquiries to bio144@ieu.uzh.ch
